...
public class ShortObjectHashMapTest {
    ...
    public void putAllShouldSucceed() {
        ...
        ShortObjectHashMap<Value> map2 = new ShortObjectHashMap<Value>();
        map2.putAll(map);
    ...
    public void iteratorShouldTraverseEntries() {
        ...
        for (ShortObjectMap.Entry<Value> entry : map.entries()) {
    ...
    public void fuzzTest() {
        ...
        for (int i = 0; i < goodKeys.length; ++i) {
            assertEquals((short) goodKeys[i], keys[i]);
        }
