...
public class ByteObjectHashMapTest {
    ...
    public void putAllShouldSucceed() {
        ...
        ByteObjectHashMap<Value> map2 = new ByteObjectHashMap<Value>();
        map2.putAll(map);
    ...
    public void iteratorShouldTraverseEntries() {
        ...
        for (ByteObjectMap.Entry<Value> entry : map.entries()) {
    ...
    public void hashcodeEqualsTest() {
        ...
        map2.put(keys[50], Byte.valueOf(map1.keys()[50]));
        assertEquals(map1, map2);
        assertEquals(map1.hashCode(), map2.hashCode());
        // Make map2 have one extra element, will be non-equal.
        map2.put((byte) 100, (byte) 100);
        assertFalse(map1.equals(map2));
    ...
    public void fuzzTest() {
        ...
        for (int i = 0; i < goodKeys.length; ++i) {
            assertEquals((byte) goodKeys[i], keys[i]);
        }
