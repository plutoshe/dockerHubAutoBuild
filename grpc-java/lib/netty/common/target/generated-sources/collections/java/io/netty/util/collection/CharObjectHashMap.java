 ...
 */
public class CharObjectHashMap<V> implements CharObjectMap<V>, Iterable<CharObjectMap.Entry<V>> {
    ...
    @Override
    public void putAll(CharObjectMap<V> sourceMap) {
        ...
        return new AbstractCollection<V>() {
            ...
            public Iterator<V> iterator() {
                return new Iterator<V>() {
                    final Iterator<Entry<V>> iter = CharObjectHashMap.this.iterator();
                    @Override
