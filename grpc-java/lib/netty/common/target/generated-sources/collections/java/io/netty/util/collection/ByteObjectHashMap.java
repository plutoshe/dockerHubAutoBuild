 ...
 */
public class ByteObjectHashMap<V> implements ByteObjectMap<V>, Iterable<ByteObjectMap.Entry<V>> {
        ...
        return new AbstractCollection<V>() {
            ...
            public Iterator<V> iterator() {
                return new Iterator<V>() {
                    final Iterator<Entry<V>> iter = ByteObjectHashMap.this.iterator();
                    @Override
