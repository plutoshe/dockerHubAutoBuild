...
@rem ##########################################################################
@rem
@rem  mapreduce-server startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and MAPREDUCE_SERVER_OPTS to pass JVM options to this script.
...
@rem Execute mapreduce-server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MAPREDUCE_SERVER_OPTS%  -classpath "%CLASSPATH%" mapreduce.MapreduceServer %CMD_LINE_ARGS%
...
:fail
rem Set variable MAPREDUCE_SERVER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%MAPREDUCE_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
